...
public class CellClassifier {
	...
	private static Color UNKNOWN = new Color(75,155,69), UNKNOWN2 = new Color(102,202,107);
	static {
	...
	public static Rectangle reduceBoard(BufferedImage img) {
		...
		int topLeft = new Color(39,97,50).getRGB();
		int bottomRight = new Color(33,71,55).getRGB();
		...
		outerloop:
		for(int x=w-10; x > 4*w/5; x--)
			for(int y=h-10; y > 4*h/5; y--)
